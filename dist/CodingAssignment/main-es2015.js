...
class AppComponent {
    ...
    getPatientDetails(patientID) {
        this.http
            .get("https://r2.smarthealthit.org/Patient/545826")
            .subscribe(x => {
            console.log(x);
        });
    }
...
module.exports = __webpack_require__(/*! C:\Users\SwathiNaresh\Tests\HL7\CodingAssignment\src\main.ts */"./src/main.ts");
