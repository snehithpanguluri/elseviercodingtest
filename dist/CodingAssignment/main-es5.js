...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function AppComponent(http) {
        ...
        this.http = http;
        this.title = "CodingAssignment";
      }

      _createClass(AppComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          this.getPatientDetails("545826");
        }
      }, {
        key: "getPatientDetails",
        value: function getPatientDetails(patientID) {
          this.http.get("https://r2.smarthealthit.org/Patient/545826").subscribe(function (x) {
            console.log(x);
          });
        }
      }]);
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\SwathiNaresh\Tests\HL7\CodingAssignment\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
